...
<% ArrayList<FuncionarioModel> lista = (ArrayList<FuncionarioModel>)request.getAttribute("funcionarios"); %>
...
<body>
<fieldset>
    <legend style="text-align: center;font-family: 'Times New Roman'"><strong><i class="fas fa-users"></i>Lista de Funcionarios</strong></legend></legend>
